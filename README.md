...
| **AXI4-Lite I2C Peripheral 타이밍 파형** | **Basys3 FPGA 기반 I2C Master & Slave 연동** |
...
* **고찰 및 교훈**:
  ...
  * 초기에 SoC 및 계층형 소프트웨어 아키텍처(Application-Driver-HAL) 개념이 미숙하여 하드웨어/소프트웨어 간의 역할 분담을 명확히 정의하지 못했던 아쉬움이 남음.
